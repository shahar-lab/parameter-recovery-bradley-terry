...
data_dir <- "./simulations/parm_recovery_beta_utility_compared_5_for_real_data_permutation_2/data_local/"
figs_dir <- "./simulations/parm_recovery_beta_utility_compared_5_for_real_data_permutation_2/figs_local/"

data_path = './simulations/parm_recovery_beta_utility_compared_5_for_real_data_permutation_2/data_local/'
raw_data <- read.csv(paste0(data_path, "constant_mix_data_20_subs_for_bradley_terry.csv"))
