...
source('./models/beta_utility_compared_5/beta_utility.R')

data_path = './simulations/parm_recovery_beta_utility_compared_5/data/'
...
for (subject in 1:cfg$Nsubjects) {
  ...
  df_temp = sim.block(subject, 
                      true_parameters$u_matrix[subject,], # תיקון מ-u ל-u_matrix
